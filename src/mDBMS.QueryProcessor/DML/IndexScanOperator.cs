...
// TODO: REPLACE STUB LOGIC WITH ACTUAL INDEX SCANNING SOLUTION
class IndexScanOperator : Operator
{
    ...
    public IndexScanOperator(IStorageManager storageManager, QueryPlanStep queryPlanStep, LocalTableStorage localTableStorage)
